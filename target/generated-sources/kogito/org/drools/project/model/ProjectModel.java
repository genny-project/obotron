...
public class ProjectModel implements org.drools.modelcompiler.CanonicalKieModuleModel {
    ...
    public java.util.List<Model> getModels() {
        return java.util.Arrays.asList(new life.genny.obotron.inference.Rulesc26a6f3d84904fddaf5e0cf44568a587(),new life.genny.obotron.Rulesefa18191fe0d484193e437a7c2a59a26());
    }

    public java.util.List<Model> getModelsForKieBase(String kieBaseName) {
        switch (kieBaseName) {
            case "defaultKieBase": return java.util.Arrays.asList( new life.genny.obotron.inference.Rulesc26a6f3d84904fddaf5e0cf44568a587(),new life.genny.obotron.Rulesefa18191fe0d484193e437a7c2a59a26() );
        }
