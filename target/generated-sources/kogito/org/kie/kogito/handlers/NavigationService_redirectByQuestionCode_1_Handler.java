...
public class NavigationService_redirectByQuestionCode_1_Handler implements org.kie.kogito.internal.process.runtime.KogitoWorkItemHandler {

    life.genny.kogito.common.service.NavigationService service;

    public NavigationService_redirectByQuestionCode_1_Handler() {
        this(new life.genny.kogito.common.service.NavigationService());
    }

    @javax.inject.Inject()
    public NavigationService_redirectByQuestionCode_1_Handler(life.genny.kogito.common.service.NavigationService service) {
    ...
    public String getName() {
        return "life.genny.kogito.common.service.NavigationService_redirectByQuestionCode_1_Handler";
    }
}
