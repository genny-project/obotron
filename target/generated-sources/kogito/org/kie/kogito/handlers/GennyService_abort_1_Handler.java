...
public class GennyService_abort_1_Handler implements org.kie.kogito.internal.process.runtime.KogitoWorkItemHandler {

    life.genny.obotron.setupBaseEntitys.GennyService service;

    public GennyService_abort_1_Handler() {
        this(new life.genny.obotron.setupBaseEntitys.GennyService());
    }

    @javax.inject.Inject()
    public GennyService_abort_1_Handler(life.genny.obotron.setupBaseEntitys.GennyService service) {
    ...
    public String getName() {
        return "life.genny.obotron.setupBaseEntitys.GennyService_abort_1_Handler";
    }
}
