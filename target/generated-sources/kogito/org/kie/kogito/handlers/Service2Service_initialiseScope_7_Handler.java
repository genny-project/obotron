...
public class Service2Service_initialiseScope_7_Handler implements org.kie.kogito.internal.process.runtime.KogitoWorkItemHandler {

    life.genny.kogito.common.service.Service2Service service;

    public Service2Service_initialiseScope_7_Handler() {
        this(new life.genny.kogito.common.service.Service2Service());
    }

    @javax.inject.Inject()
    public Service2Service_initialiseScope_7_Handler(life.genny.kogito.common.service.Service2Service service) {
    ...
    public String getName() {
        return "life.genny.kogito.common.service.Service2Service_initialiseScope_7_Handler";
    }
}
