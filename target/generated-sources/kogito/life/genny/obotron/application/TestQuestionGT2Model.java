...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "testQuestionGT2", name = "TestQuestionGT2", hidden = false)
public class TestQuestionGT2Model implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<TestQuestionGT2ModelOutput> {
    ...
    @Override()
    public TestQuestionGT2ModelOutput toModel() {
        TestQuestionGT2ModelOutput result = new TestQuestionGT2ModelOutput();
        result.setId(getId());
