...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "callProcessQuestionsGT", name = "CallProcessQuestionsGT", hidden = false)
public class CallProcessQuestionsGTModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<CallProcessQuestionsGTModelOutput> {
    ...
    @Override()
    public CallProcessQuestionsGTModelOutput toModel() {
        CallProcessQuestionsGTModelOutput result = new CallProcessQuestionsGTModelOutput();
        result.setId(getId());
