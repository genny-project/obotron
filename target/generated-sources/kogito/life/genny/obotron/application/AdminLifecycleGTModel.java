...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "adminLifecycleGT", name = "AdminLifecycleGT", hidden = false)
public class AdminLifecycleGTModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<AdminLifecycleGTModelOutput> {
    ...
    @org.kie.kogito.codegen.VariableInfo(tags = "input")
    @com.fasterxml.jackson.annotation.JsonProperty(value = "userCode")
    @javax.validation.Valid()
    ...
    @Override()
    public AdminLifecycleGTModelOutput toModel() {
        AdminLifecycleGTModelOutput result = new AdminLifecycleGTModelOutput();
        result.setId(getId());
