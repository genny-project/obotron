...
@ProcessInput(processName = "adminLifecycleGT")
public class AdminLifecycleGTModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<AdminLifecycleGTModel> {
    ...
    public AdminLifecycleGTModel toModel() {
        ...
        result.setUserCode(getUserCode());
        return result;
    }
}
