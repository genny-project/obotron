...
public class Rules519d5e5ce47c496f99c19a65e2b85e3b_rule_RetractEvent {
    ...
    public static org.drools.model.Rule rule_RetractEvent() {
        ...
        org.drools.model.Rule rule = D.rule("life.genny.obotron",
                                      ...
                                      .build(D.pattern(var_msg),
                                             D.on(var_msg).execute(life.genny.obotron.P16.LambdaConsequence16440D98A506B62E5854A7491A89F9D3.INSTANCE));
        return rule;
    }
}
